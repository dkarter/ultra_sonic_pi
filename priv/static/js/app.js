...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _randomColor = __webpack_require__(121);
	...
	var UltraSonicPiClient = {
	  ...
	  init: function init(token) {
	    ...
	    var songId = codeContainer.getAttribute('data-id');
	    var songChan = this.socket.channel('songs:' + songId);

	    songChan.join().receive('ok', function (resp) {
	      return console.log('joined!', resp);
	    }).receive('error', function (resp) {
	      return console.log('error join', resp);
	    });

	    // ====================================================
	    //                    Channel Events
	    // ====================================================
	    songChan.on('text_change', function (_ref) {
	      var changes = _ref.changes,
	          author = _ref.author;

	      changes.map(function (chng) {
	        _this.editor.replaceRange(chng.text, chng.from, chng.to, 'socket');
	      });

	      var logItem = document.createElement('li');
	      logItem.innerHTML = author + ' is typing...';
	      _this.messageLog.appendChild(logItem);

	      setTimeout(function (_) {
	        return _this.messageLog.removeChild(logItem);
	      }, 500);
	    });

	    songChan.on('cursor_change', function (_ref2) {
	      var cursor = _ref2.cursor,
	          author = _ref2.author;

	      if (_this.cursors[author]) {
	        _this.cursors[author].cursor.remove();
	      } else {
	        _this.cursors[author] = {
	          color: (0, _randomColor2.default)().hexString(),
	          cursor: document.createElement('div')
	        };
	      }

	      var widget = _this.cursors[author].cursor;
	      widget.className = 'alt-cursor';
	      widget.style.backgroundColor = _this.cursors[author].color;

	      var nameTag = document.createElement('div');
	      var nameText = document.createTextNode(author);
	      ...
	      _this.editor.addWidget({ ch: char, line: line }, widget, true);
	    });
	    ...
	    this.editor.on('cursorActivity', function (codeMirror) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* MIT license */
	var cssKeywords = __webpack_require__(130);
